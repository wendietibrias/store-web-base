      ...
      <div className="p-3">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-[0.85rem] text-alternative-secondary">{subName}</p>
          </div>
          <h5 className="text-primary-clr text-[0.85rem] font-extrabold">Rp. {currencyFormatter(price!)}</h5>
        </div>
        <div className="mt-3">
          <ButtonCn icon={<RiShoppingCartFill/>} variant="ghost" isPrimary={true} loading={false} title="Add To Cart" mode="dark" size="sm" type="button" />
        </div>
      </div>
    </div>
    </Link>
